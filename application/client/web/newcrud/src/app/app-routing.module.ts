...
{ path : 'updatetree', loadChildren: () => import('./updatetree/updatetree.module').then(m => m.UpdatetreeModule), canActivate: [AuthGuard] } , 
{ path : 'treedatas', loadChildren: () => import('./treedatas/treedatas.module').then(m => m.TreedatasModule), canActivate: [AuthGuard] } , 
];
